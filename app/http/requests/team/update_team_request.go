...
type UpdateTeamRequest struct {
	...
	RemoveLogo   string `form:"remove_logo" json:"remove_logo"`
}

func (r *UpdateTeamRequest) Authorize(ctx http.Context) error {
	return nil
}

func (r *UpdateTeamRequest) Rules(ctx http.Context) map[string]string {
...
func (r *UpdateTeamRequest) Messages(ctx http.Context) map[string]string {
	return map[string]string{
...
func (r *UpdateTeamRequest) Attributes(ctx http.Context) map[string]string {
	return map[string]string{
		"name":          "nombre",
		"color":         "color",
...
func (r *UpdateTeamRequest) PrepareForValidation(ctx http.Context, data validation.Data) error {
	return nil
}
