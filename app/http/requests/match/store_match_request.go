...
func (r *StoreMatchRequest) Authorize(ctx http.Context) error {
	return nil
}

func (r *StoreMatchRequest) Rules(ctx http.Context) map[string]string {
...
func (r *StoreMatchRequest) Messages(ctx http.Context) map[string]string {
	return map[string]string{
...
func (r *StoreMatchRequest) Attributes(ctx http.Context) map[string]string {
	return map[string]string{
...
func (r *StoreMatchRequest) PrepareForValidation(ctx http.Context, data validation.Data) error {
	return nil
}
