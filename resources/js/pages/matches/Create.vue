...
const form = useForm({
  tournament_id: page.props.tournamentId ? parseInt(page.props.tournamentId) : null as number | null,
...
const submit = () => form.post("/matches");
</script>
      ...
      <v-card-text class="pa-6">
        <v-form @submit.prevent="submit">
          ...
          <div class="d-flex ga-4">
            <v-btn type="submit" color="primary" :loading="form.processing">Crear Partido</v-btn>
