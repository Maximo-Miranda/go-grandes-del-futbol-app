...
const playerName = computed(() => props.player.user?.name || "Jugador");
const displayName = computed(() => props.player.nickname || playerName.value);
const isOwnProfile = computed(() => {
    const authPlayer = (page.props.auth as any)?.player;
    return authPlayer && authPlayer.id === props.player.id;
});
        ...
        <v-row justify="center">
                ...
                >
                    ...
                    >
                        <div class="text-center">
                            <div
                                class="text-h2 font-weight-black text-amber"
                                style="line-height: 1"
                            >
                                {{ overall }}
                            </div>
                    ...
                    <div class="text-center mt-3 px-4">
                        <div
                            class="text-h5 font-weight-black text-white text-uppercase"
                    ...
                    <div class="px-4 py-3">
                        <div
                            class="text-caption text-amber font-weight-bold mb-2"
                        >
                            📊 ESTADÍSTICAS
                        </div>
                    ...
                    <!-- Actions -->
                    <div v-if="isOwnProfile" class="px-4 pb-4 text-center">
                        <Link href="/profile/edit" class="text-decoration-none">
                            <v-btn
                                color="amber"
                                variant="tonal"
            ...
            <v-col cols="12" sm="6" md="5" lg="4">
                <v-card rounded="xl" color="grey-darken-4" class="pa-4">
                    <div class="text-h6 text-amber font-weight-bold mb-3">
                        📋 Últimos Partidos
                    </div>
